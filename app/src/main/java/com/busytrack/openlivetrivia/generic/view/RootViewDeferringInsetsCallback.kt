package com.busytrack.openlivetrivia.generic.view
...
class RootViewDeferringInsetsCallback(
    ...
    override fun onApplyWindowInsets(
        ...
        v.updateLayoutParams<ViewGroup.MarginLayoutParams> {
            topMargin = typeInsets.top
            bottomMargin = typeInsets.bottom
            leftMargin = typeInsets.left
            rightMargin = typeInsets.right
        }
